...
# ============================================================
    ...
    if not st.session_state.authenticated:
        ...
        st.success("✅ Authenticated as **kotvvina@amazon.com**")
        st.markdown("---")
        ...
        st.success("✅ Authenticated as **kotvvina@amazon.com** | ✅ Consent granted")
        st.markdown("---")
        ...
        st.success("✅ Authenticated as **kotvvina@amazon.com** | ✅ Profile auto-imported")
        st.markdown("---")
...
# ============================================================
    ...
    with col2:
        ...
        <div style="background:#e3f2fd; border-radius:10px; padding:15px; text-align:center; border-top:4px solid #0073bb;">
            ...
            • Phonetool + Amazon Learn APIs<br>
            • 50-user pilot within SPEx
            </p>
        </div>
        """, unsafe_allow_html=True)
    with col3:
    ...
    | Data Sources | Sample profiles | Phonetool, Amazon Learn, Forte, JIRA APIs |
